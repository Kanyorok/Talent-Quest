...
****************************************************************************************/
            ...
            <br>
                ...
                <strong>Great to have a new player!<br></strong>
                 <p> The new player has been registered successfully.</p>
                ...
                elseif ($err_state==3.6) 
            	{
            		$error="<div id='dlt' class='alert alert-slim w3-card-4 alert-success fade in'> 
                <h1><a href=\"index.php\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\"> &times;</a> </h1>
                <div> <i class='fa fa-user fa-3x'></i> </div>
                <strong>Record Updated Successfully<br></strong>
                ...
                <p>It seems we had a little problem registering the new player. Please try again.</p>  <br>
            ...
            <br>
                ...
                elseif ($err_state==10) {
                    $error="<div id='dlt' class='alert alert-slim w3-card-4 alert-success fade in'> 
                <h1><a href=\"index.php\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\"> &times;</a> </h1>
                <div class='center'><i class='fa fa-users fa-3x'></i></div>
                <strong>A new club was added!</strong><br>
                <p>A new club was added successfully.</p>  <br>
