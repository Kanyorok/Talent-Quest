<?php 
     ...
     ***************************************************/
                       if (isset($_POST['submit'])) 
                       {
                        ...
                        $sq="INSERT into `clubs` (`club_name`) values ('$location')";
    ...
    //request to delete
        if (isset($_GET['del'])) {
            ...
            //delete
            mysqli_query($conn, "DELETE FROM `clubs` where `id`=$locid");
        }
                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="houses.php">New Club</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="white-box">
                            ...
                            <h3 class="box-title m-b-0"><i class="fa fa-users fa-3x"></i> Add A New Club</h3>
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <form action="new-location.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="hname">Club Name *</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-pencil"></i></div>
                                                <input type="text" required name="hname" class="form-control" id="hname" placeholder="Enter a New Club Name" required=""> </div>
                                        </div>

                                        

                                        <button type="submit" name="submit" class="btn btn-success btn-lg waves-effect waves-light m-r-10 center"><i class="fa fa-plus-circle fa-lg"></i> Add this Club</button>
                                    </form>
                                </div>
                            </div>
                        </div>
