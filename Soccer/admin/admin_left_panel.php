...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        <ul class="nav" id="side-menu">
            ...
            <li class="user-pro">
                <a href="#" class="waves-effect"><img src="../plugins/images/user.jpg" alt="user-img" class="img-circle"> 
            ...
            <?php if ($userRole !== 'level-0') {  ?>
            <li><a href="new-location.php" class="waves-effect"><i class="fa fa-map-marker fa-2x"></i> <span class="hide-menu"> || Clubs</span></a></li>
